                ...
                <div class="item-card flex flex-row justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div class="flex flex-col">
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{ \Illuminate\Support\Str::limit($blog->title, $limit = 20, $end = '...') }}</h3>
                        </div>
                    </div> 
                    <div  class="hidden md:flex flex-col">
                        <p class="text-slate-500 text-sm">Writer</p>
                        <h3 class="text-indigo-950 text-xl font-bold">{{$blog->author ? $blog->author->name : 'Null'}}</h3>
                    </div>

                    <div  class="hidden md:flex flex-col">
                        <p class="text-slate-500 text-sm">Category</p>
                        <h3 class="text-indigo-950 text-xl font-bold">
                            {{ $blog->category ? $blog->category->name : 'Null' }}
                        </h3>
                    </div>
