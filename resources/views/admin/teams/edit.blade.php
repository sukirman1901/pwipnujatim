            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                ...
                <form method="POST" action="{{route('admin.teams.update', $team)}}" enctype="multipart/form-data"> 
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{$team->name}}"
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="location" class="block mt-1 w-full" type="text" name="location" value="{{$team->location}}"
